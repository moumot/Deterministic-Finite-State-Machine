...
int main(int argc, char* argv[])
{
	...
	char* filename = "M4.dfa.txt";
	string tinput = "aababbb";
	...
	y = verify(alphabet, tinput.substr(0, 1), alphabetnum);
	if (y < 0)
	{
		cout << "No" << "\n";
		return 0;
	...
	while (tinput[i] != '\0')
	{
		y = verify(alphabet, tinput.substr(i, 1), alphabetnum);
		if (y < 0)
		{
			cout << "No" << "\n";
			return 0;
